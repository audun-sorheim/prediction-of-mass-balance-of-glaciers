...
def import_datasets(loc):
    ...
    train_data = pd.read_pickle('data_HMA\HMA_' + loc + 'train_data.pkl')
    val_data = pd.read_pickle('data_HMA\HMA_' + loc + 'test_data.pkl')
    test_data = pd.read_pickle('data_HMA\HMA_' + loc + 'val_data.pkl')
