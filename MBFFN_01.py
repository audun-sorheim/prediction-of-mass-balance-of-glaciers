...
train_features = train_data[['TMPP', 'Snow']]
train_labels = train_data['MBA']

# we do the same for the validation and test datasets
val_features = val_data[['TMPP', 'Snow']]
val_labels = val_data['MBA']
test_features = test_data[['TMPP', 'Snow']]
test_labels = test_data['MBA']
...
fnn_model.save('FNN_MB_3L_sigmoid_01.keras')
...
plt.title('FNN: 12(sigmoid)-12(sigmoid)-12(sigmoid)')
plot_loss(history)
