...
def import_datasets(loc):
    ...
    train_data = pd.read_pickle('data_SA\patagonia_' + loc + 'train_data.pkl')
    val_data = pd.read_pickle('data_SA\patagonia_' + loc + 'test_data.pkl')
    test_data = pd.read_pickle('data_SA\patagonia_' + loc + 'val_data.pkl')
