...
def import_datasets(loc):
    ...
    train_data = pd.read_pickle('data_EU\EU_' + loc + 'train_data.pkl')
    val_data = pd.read_pickle('data_EU\EU_' + loc + 'test_data.pkl')
    test_data = pd.read_pickle('data_EU\EU_' + loc + 'val_data.pkl')

    return train_data, val_data, test_data

loc = 'north_scandinavia_'
